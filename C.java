...
class ListeningAtC implements Runnable
{
...
//                            byte send[]=generateDataGram((byte)2,dt[1],dt[2],dt[3],(byte)1);
                        DpSend = new DatagramPacket(s1, s1.length,ip,1234);
                        ds_sen.send(DpSend);
...
public class C {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        Thread.sleep(10000);
        ListeningAtC la=new ListeningAtC();
        ...
        try {
            ...
            while (true) {
                ...
                DatagramPacket DpSend =
                        new DatagramPacket(buf, buf.length, ip, 1234); //A's Port number:

                // Step 3 : invoke the send call to actually send
                // the data.
                ds.send(DpSend);
//                System.out.println("Sent Green packet with details "+buf);
                printData(buf);
            }
