        ...
        try {
            ...
            while (true) {
                ...
                try {
                    ...
                    if(dt[0]==0)//Red color's Action
                    {
                        DatagramPacket g1=null,g2=null;
                        dt[1]--;
                        byte s1[] = generateDataGram((byte)2,(byte)8,dt[2],dt[3],(byte)1);
                        byte s2[] = generateDataGram((byte)2,(byte)8,dt[2],dt[3],(byte)0);
                        ...
                        DpSend = new DatagramPacket(s2, s2.length,ip,1234);
                        ds_sen.send(DpSend);
...
public class A {
    //Let each of the 3 classes A,B,C be running in different ports:
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        try {
            ...
            while (true) {
                ...
                ds.send(DpSend);
//                System.out.println("Sent Red packet with details "+buf);
                printData(buf);
            }
